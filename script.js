document.addEventListener('DOMContentLoaded', () => {
    ...
    copyAllBtn.addEventListener('click', () => {
        const allKeys = Array.from(keysList.querySelectorAll('input')).map(input => input.value).join('\n');
    ...
    // Show previous keys on game change
    gameSelect.addEventListener('change', showPreviousKeys);

    // Show previous keys on page load
    showPreviousKeys();
});
